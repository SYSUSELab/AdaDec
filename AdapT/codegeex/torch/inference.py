...
def sample_sequence_batch(
        ...
        context_lengths,
        attention_mask,
        position_ids,   # 不再使用，可以忽略
        seq_length,
        out_seq_length,
        temp=None,
        maxlen=None,
        return_scores: bool = False,
        prompt_length: int = None,  # 不再使用，可以忽略
        bad_ids: List = None,
        temperature: float = 1.0,
        topp: float = 1.0,
        topk: int = 0.0,
    ...
    with torch.no_grad():
        ...
        past_key_values = None   # 替代 CodeGeeX 的 layer_past
        ...
        while context_length <= maxlen:
            ...
            if recompute:
                ...
                if counter == 0:
                    ...
                    tokens2use = tokens[:, context_length - 1].unsqueeze(-1)
            ...
            if greedy:
                ...
                logits /= torch.tensor(temperature).to(logits.device)
