...
from llm.generator2 import Generator
...
parser.add_argument('--dir', help='', required=False, type=str)
...
def main():
    ...
    filename = f"experiments/{args.dataset}_outputs/{args.model}/{args.decoding_mode}/{args.dir}/{args.model}"
